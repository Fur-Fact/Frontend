    ...
    <div className='flex flex-col justify-between h-4/5 items-center mx-14'>
      <div className='w-full h-full bg-white p-4 shadow-md rounded-lg mt-[3%]'>
        <div className='flex justify-between pr-4'>
          ...
          />
          <div className='flex mt-2 text-right text-lg font-semibold text-gray-700 whitespace-pre-wrap'>
            {guardianName} <p className='text-gray-500 text-sm'>|</p> {petName}{' '}
            <p>|</p> {age}살 <p>|</p> {gender}
            <p>|</p> {weight}kg
          </div>
        </div>
